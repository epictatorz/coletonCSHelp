...
void LinkedList::deleteItem (int item)
{
  ...
  while (currPtr != NULL && currPtr -> datum != item)
    {
      prevPtr = currPtr;
      currPtr=currPtr->next;
    }
  if (currPtr == head)
    ...
    {
      cout << endl << "Item was not found int the list" << endl << endl;
    }
  else
    {
...
void LinkedList::printList () 
{
  ...
  for (ListElement *currPtr = head; currPtr != NULL; currPtr = currPtr -> next)
    {
      cout << currPtr -> datum << " ";
    }
  cout << endl;
